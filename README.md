...
**Stack**
`Python` `FastAPI` `React` `AWS` `Terraform` `Docker` `HNSWLib` `Azure OpenAI` `Next.js`

**Find me**
[biancabodo.github.io](https://biancabodo.github.io) · [LinkedIn](https://www.linkedin.com/in/bianca-bodo)
